include {
  ...
  inputs = {
    ...
    subnetwork         = "subnet-${include.project.locals.environment_short}-${include.resource.locals.region_prefix}-stock" #string alpaca
    subnetwork_project = include.resource.locals.project_subnetwork
  
    size_root_disk = 15 #number ie 2
    type_root_disk = "pd-standard" #string ie pd-balanced or standard
    ...
    labels = {
      ...
      service_group     = "stock" #string ie alpaca
